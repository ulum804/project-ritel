    ...
    <div class="main-container">
        ...
        <div class="content">
            ...
            <div class="warehouse-info" id="warehouseInfo">
                ...
                Anda sedang mengelola <strong>Warehouse 4</strong>
            </div>
                    ...
                    <form onsubmit="submitTransfer(event)">
                        <div class="form-row">
                            <div class="form-group-custom">
                                ...
                                <input type="text" id="fromWarehouse" value="Warehouse 4" readonly>
                            </div>
                            <div class="form-group-custom">
        ...
        function updateWarehouseOptions() {
            if (currentWarehouse === 1) {
                ...
                document.getElementById('toWarehouse').innerHTML = `
                    ...
                    <option value="1">Warehouse 4</option>
                `;
            }
        }
